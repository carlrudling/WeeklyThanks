...
//    var recipients: [String]?
//    var body: String?
//    var bodyImages: [UIImage] // Changed to an array
//    let completion: (_ messageSent: Bool) -> Void
//
//    func makeUIViewController(context: Context) -> MFMessageComposeViewController {
//        let composer = MFMessageComposeViewController()
...
//        composer.body = body
//
//        // Attach each image available
//        for (index, image) in bodyImages.enumerated() {
//            if let imageData = image.pngData() {
//                composer.addAttachmentData(imageData, typeIdentifier: "public.png", filename: "capturedImage\(index).png")
//            }
//        }
//
//        return composer
